        ...
        <div className='mt-5 space-y-1'>
          {show.dateTime[date].map((item) => (
            <div
              ...
              className={`flex items-center ga-2 px-6 py-2 w-max rounded-r-md cursor-pointer transition ${
...
<button onClick={()=>navigate('/my-bookings')} className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full medium cursor-pointer active:scale-95'
  >
  Proceed to checkout
