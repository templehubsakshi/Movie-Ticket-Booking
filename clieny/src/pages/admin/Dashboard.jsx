...
{ dashboardData.activeShows.map((show)=>(
  <div key={show.id} className="w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 duration-300">
    ...
    <p className='px-2 pt-2 text-sm text-gray-500'>{dateFormat(show.showTime)}</p>
